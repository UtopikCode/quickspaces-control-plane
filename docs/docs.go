...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/api.AccessRuleResponse"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.GrantAccessRequestPayload"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.RemoveAccessRequestPayload"
                        }
                    }
                ],
                "responses": {
        ...
        "/hosts": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/api.ExecutionHostResponse"
                            }
                        }
                    },
                    "401": {
            ...
            "post": {
                ...
                "description": "Registers an execution host with provider-specific config that can be bound to workspaces.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.CreateHostRequestPayload"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.CreateWorkspaceRequestPayload"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "api.CreateWorkspaceRequestPayload": {
            "type": "object",
            "properties": {
                "executionProfile": {
                    "type": "object",
        ...
        "api.RemoveAccessRequestPayload": {
            "type": "object",
            "properties": {
                "subjectId": {
                    "type": "string"
